...
pub use generated::{
    ...
    CAPABILITY_PAINT_COMMANDS, CAPABILITY_RASTER_SURFACE, CAPABILITY_RENDER_SURFACE,
    CAPABILITY_RETAINED_CANVAS, CAPABILITY_RETAINED_SCROLL, CAPABILITY_RETAINED_TREE,
    CAPABILITY_SHADER_AUTHORING, CAPABILITY_STANDARD_EVENTS, CAPABILITY_STREAM,
    CAPABILITY_SUBTREE_LIFECYCLE, CAPABILITY_TYPED_STYLE, CAPABILITY_VALIDATION_PATTERN,
