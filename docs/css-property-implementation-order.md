...
| Runtime | Currently affects layout, paint, hit testing, text rendering, or another runtime subsystem | 183 |
| Computed | Accepted and resolved, but full runtime behavior is still partial | 68 |
...
As of 2026-08-26, strict runtime completion is **183/427 (42.9%)**.
