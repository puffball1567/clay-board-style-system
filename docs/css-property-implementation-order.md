...
| Runtime | Currently affects layout, paint, hit testing, text rendering, or another runtime subsystem | 178 |
| Computed | Accepted and resolved, but full runtime behavior is still partial | 73 |
...
As of 2026-08-25, strict runtime completion is **178/427 (41.7%)**.
