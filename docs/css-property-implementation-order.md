...
| Runtime | Currently affects layout, paint, hit testing, text rendering, or another runtime subsystem | 150 |
| Computed | Accepted and resolved, but full runtime behavior is still partial | 84 |
| Metadata | Preserved for later subsystems or design/tooling interchange | 193 |
