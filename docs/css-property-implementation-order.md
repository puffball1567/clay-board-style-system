...
| Runtime | Currently affects layout, paint, hit testing, text rendering, or another runtime subsystem | 190 |
| Computed | Accepted and resolved, but full runtime behavior is still partial | 61 |
