...
handleEventSlot(`onAnimationCancel=`, iekAnimationCancel)
handleEventSlot(`onTransitionRun=`, iekTransitionRun)
handleEventSlot(`onTransitionStart=`, iekTransitionStart)
handleEventSlot(`onTransitionCancel=`, iekTransitionCancel)
