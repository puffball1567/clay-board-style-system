...
proc inheritBorderWidth(style: var ComputedStyle; property: string;
...
proc setBorderRadius(style: var ComputedStyle; property: string;
    value: float32) =
  case property
  of "border-radius":
...
proc inheritBorderRadius(style: var ComputedStyle; property: string;
    parent: ComputedStyle) =
  case property
  of "border-radius":
...
proc inheritBorderColor(style: var ComputedStyle; property: string;
    parent: ComputedStyle) =
  case property
  of "border-color":
...
proc applyBorderColor(
  ...
  of mmOverwrite:
    ...
    style.setBorderColor(
      ...
      declaration.operation.value.get.resolveStyleColor(style, env)
    )
  of mmInitial, mmUnset:
...
proc setBorderVisibility(style: var ComputedStyle; property: string;
    visible: bool) =
  case property
  of "border-style":
...
proc inheritBorderVisibility(style: var ComputedStyle; property: string;
    parent: ComputedStyle) =
  case property
  of "border-style":
...
proc applyStructuredBorder(
  ...
  if color.isSome:
    style.setBorderColor(colorProperty, color)
  ...
  of mmOverwrite:
    ...
    of svLength:
      ...
      if resolved.isSome:
        style.setBorderWidth(widthProperty, resolved.get)
    of svColor:
      style.setBorderColor(colorProperty, value.resolveStyleColor(style, env))
    of svColorPair:
    ...
    of svBorder:
      style.applyStructuredBorder(declaration.property, value, env, diagnostics)
    of svShadow:
...
proc setBorderMetadata(style: var ComputedStyle; property: string;
    value: Option[string]) =
  case property
  of "border-image":
...
proc applyBorderMetadata(
  ...
  of mmInherit:
    if env.parent.isSome:
      style.setBorderMetadata(declaration.property,
          env.parent.get.borderMetadata(declaration.property))
    else:
      diagnostics.addError(declaration.property, "cannot inherit " &
          declaration.property & " without parent")
  of mmRelative:
...
let borderTopProperty* = PropertyImpl(name: "border-top",
    apply: applyBorderShorthand)
let borderRightProperty* = PropertyImpl(name: "border-right",
    apply: applyBorderShorthand)
let borderBottomProperty* = PropertyImpl(name: "border-bottom",
    apply: applyBorderShorthand)
let borderLeftProperty* = PropertyImpl(name: "border-left",
    apply: applyBorderShorthand)
let borderInlineProperty* = PropertyImpl(name: "border-inline",
    apply: applyBorderShorthand)
let borderInlineStartProperty* = PropertyImpl(name: "border-inline-start",
    apply: applyBorderShorthand)
let borderInlineEndProperty* = PropertyImpl(name: "border-inline-end",
    apply: applyBorderShorthand)
let borderBlockProperty* = PropertyImpl(name: "border-block",
    apply: applyBorderShorthand)
let borderBlockStartProperty* = PropertyImpl(name: "border-block-start",
    apply: applyBorderShorthand)
let borderBlockEndProperty* = PropertyImpl(name: "border-block-end",
    apply: applyBorderShorthand)
let borderWidthProperty* = PropertyImpl(name: "border-width",
    apply: applyBorderWidth)
let borderTopWidthProperty* = PropertyImpl(name: "border-top-width",
    apply: applyBorderWidth)
let borderRightWidthProperty* = PropertyImpl(name: "border-right-width",
    apply: applyBorderWidth)
let borderBottomWidthProperty* = PropertyImpl(name: "border-bottom-width",
    apply: applyBorderWidth)
let borderLeftWidthProperty* = PropertyImpl(name: "border-left-width",
    apply: applyBorderWidth)
let borderInlineWidthProperty* = PropertyImpl(name: "border-inline-width",
    apply: applyBorderWidth)
let borderInlineStartWidthProperty* = PropertyImpl(
    name: "border-inline-start-width", apply: applyBorderWidth)
let borderInlineEndWidthProperty* = PropertyImpl(
    name: "border-inline-end-width", apply: applyBorderWidth)
let borderBlockWidthProperty* = PropertyImpl(name: "border-block-width",
    apply: applyBorderWidth)
let borderBlockStartWidthProperty* = PropertyImpl(
    name: "border-block-start-width", apply: applyBorderWidth)
let borderBlockEndWidthProperty* = PropertyImpl(name: "border-block-end-width",
    apply: applyBorderWidth)
let borderRadiusProperty* = PropertyImpl(name: "border-radius",
    apply: applyBorderRadius)
let borderTopLeftRadiusProperty* = PropertyImpl(name: "border-top-left-radius",
    apply: applyBorderRadius)
let borderTopRightRadiusProperty* = PropertyImpl(
    name: "border-top-right-radius", apply: applyBorderRadius)
let borderBottomRightRadiusProperty* = PropertyImpl(
    name: "border-bottom-right-radius", apply: applyBorderRadius)
let borderBottomLeftRadiusProperty* = PropertyImpl(
    name: "border-bottom-left-radius", apply: applyBorderRadius)
let borderStartStartRadiusProperty* = PropertyImpl(
    name: "border-start-start-radius", apply: applyBorderRadius)
let borderStartEndRadiusProperty* = PropertyImpl(
    name: "border-start-end-radius", apply: applyBorderRadius)
let borderEndStartRadiusProperty* = PropertyImpl(
    name: "border-end-start-radius", apply: applyBorderRadius)
let borderEndEndRadiusProperty* = PropertyImpl(name: "border-end-end-radius",
    apply: applyBorderRadius)
let borderColorProperty* = PropertyImpl(name: "border-color",
    apply: applyBorderColor)
let borderTopColorProperty* = PropertyImpl(name: "border-top-color",
    apply: applyBorderColor)
let borderRightColorProperty* = PropertyImpl(name: "border-right-color",
    apply: applyBorderColor)
let borderBottomColorProperty* = PropertyImpl(name: "border-bottom-color",
    apply: applyBorderColor)
let borderLeftColorProperty* = PropertyImpl(name: "border-left-color",
    apply: applyBorderColor)
let borderInlineColorProperty* = PropertyImpl(name: "border-inline-color",
    apply: applyBorderColor)
let borderInlineStartColorProperty* = PropertyImpl(
    name: "border-inline-start-color", apply: applyBorderColor)
let borderInlineEndColorProperty* = PropertyImpl(
    name: "border-inline-end-color", apply: applyBorderColor)
let borderBlockColorProperty* = PropertyImpl(name: "border-block-color",
    apply: applyBorderColor)
let borderBlockStartColorProperty* = PropertyImpl(
    name: "border-block-start-color", apply: applyBorderColor)
let borderBlockEndColorProperty* = PropertyImpl(name: "border-block-end-color",
    apply: applyBorderColor)
let borderStyleProperty* = PropertyImpl(name: "border-style",
    apply: applyBorderStyle)
let borderTopStyleProperty* = PropertyImpl(name: "border-top-style",
    apply: applyBorderStyle)
let borderRightStyleProperty* = PropertyImpl(name: "border-right-style",
    apply: applyBorderStyle)
let borderBottomStyleProperty* = PropertyImpl(name: "border-bottom-style",
    apply: applyBorderStyle)
let borderLeftStyleProperty* = PropertyImpl(name: "border-left-style",
    apply: applyBorderStyle)
let borderInlineStyleProperty* = PropertyImpl(name: "border-inline-style",
    apply: applyBorderStyle)
let borderInlineStartStyleProperty* = PropertyImpl(
    name: "border-inline-start-style", apply: applyBorderStyle)
let borderInlineEndStyleProperty* = PropertyImpl(
    name: "border-inline-end-style", apply: applyBorderStyle)
let borderBlockStyleProperty* = PropertyImpl(name: "border-block-style",
    apply: applyBorderStyle)
let borderBlockStartStyleProperty* = PropertyImpl(
    name: "border-block-start-style", apply: applyBorderStyle)
let borderBlockEndStyleProperty* = PropertyImpl(name: "border-block-end-style",
    apply: applyBorderStyle)
let borderImageProperty* = PropertyImpl(name: "border-image",
    apply: applyBorderMetadata)
let borderImageOutsetProperty* = PropertyImpl(name: "border-image-outset",
    apply: applyBorderMetadata)
let borderImageRepeatProperty* = PropertyImpl(name: "border-image-repeat",
    apply: applyBorderMetadata)
let borderImageSliceProperty* = PropertyImpl(name: "border-image-slice",
    apply: applyBorderMetadata)
let borderImageSourceProperty* = PropertyImpl(name: "border-image-source",
    apply: applyBorderMetadata)
let borderImageWidthProperty* = PropertyImpl(name: "border-image-width",
    apply: applyBorderMetadata)
let borderCollapseProperty* = PropertyImpl(name: "border-collapse",
    apply: applyBorderMetadata)
let borderShapeProperty* = PropertyImpl(name: "border-shape",
    apply: applyBorderMetadata)
let borderSpacingProperty* = PropertyImpl(name: "border-spacing",
    apply: applyBorderMetadata)
let cornerShapeProperty* = PropertyImpl(name: "corner-shape",
    apply: applyBorderMetadata)
let cornerTopShapeProperty* = PropertyImpl(name: "corner-top-shape",
    apply: applyBorderMetadata)
let cornerRightShapeProperty* = PropertyImpl(name: "corner-right-shape",
    apply: applyBorderMetadata)
let cornerBottomShapeProperty* = PropertyImpl(name: "corner-bottom-shape",
    apply: applyBorderMetadata)
let cornerLeftShapeProperty* = PropertyImpl(name: "corner-left-shape",
    apply: applyBorderMetadata)
let cornerTopLeftShapeProperty* = PropertyImpl(name: "corner-top-left-shape",
    apply: applyBorderMetadata)
let cornerTopRightShapeProperty* = PropertyImpl(name: "corner-top-right-shape",
    apply: applyBorderMetadata)
let cornerBottomRightShapeProperty* = PropertyImpl(
    name: "corner-bottom-right-shape", apply: applyBorderMetadata)
let cornerBottomLeftShapeProperty* = PropertyImpl(
    name: "corner-bottom-left-shape", apply: applyBorderMetadata)
let cornerBlockStartShapeProperty* = PropertyImpl(
    name: "corner-block-start-shape", apply: applyBorderMetadata)
let cornerBlockEndShapeProperty* = PropertyImpl(name: "corner-block-end-shape",
    apply: applyBorderMetadata)
let cornerInlineStartShapeProperty* = PropertyImpl(
    name: "corner-inline-start-shape", apply: applyBorderMetadata)
let cornerInlineEndShapeProperty* = PropertyImpl(
    name: "corner-inline-end-shape", apply: applyBorderMetadata)
let cornerStartStartShapeProperty* = PropertyImpl(
    name: "corner-start-start-shape", apply: applyBorderMetadata)
let cornerStartEndShapeProperty* = PropertyImpl(name: "corner-start-end-shape",
    apply: applyBorderMetadata)
let cornerEndStartShapeProperty* = PropertyImpl(name: "corner-end-start-shape",
    apply: applyBorderMetadata)
let cornerEndEndShapeProperty* = PropertyImpl(name: "corner-end-end-shape",
    apply: applyBorderMetadata)
