...
type
  BgfxPlatformData* = object
    platform*: bgfx_platform_data_t
...
proc bgfxPlatformData*(handles: BgfxNativeWindowHandles): BgfxPlatformData =
  ...
  result.swapChain.ndt = handles.display
  result.swapChain.nwh = handles.window
